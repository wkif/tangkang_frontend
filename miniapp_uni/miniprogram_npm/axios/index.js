module.exports = (function () {
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                './utils': 1658887819361,
                './helpers/bind': 1658887819362,
                './core/Axios': 1658887819363,
                './core/mergeConfig': 1658887819387,
                './defaults': 1658887819368,
                './cancel/CanceledError': 1658887819381,
                './cancel/CancelToken': 1658887819389,
                './cancel/isCancel': 1658887819386,
                './env/data': 1658887819384,
                './helpers/toFormData': 1658887819372,
                '../lib/core/AxiosError': 1658887819370,
                './helpers/spread': 1658887819390,
                './helpers/isAxiosError': 1658887819391
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                './../utils': 1658887819361,
                '../helpers/buildURL': 1658887819364,
                './InterceptorManager': 1658887819365,
                './dispatchRequest': 1658887819366,
                './mergeConfig': 1658887819387,
                './buildFullPath': 1658887819376,
                '../helpers/validator': 1658887819388
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                '../utils': 1658887819361,
                '../helpers/normalizeHeaderName': 1658887819369,
                '../core/AxiosError': 1658887819370,
                './transitional': 1658887819371,
                '../helpers/toFormData': 1658887819372,
                '../adapters/xhr': 1658887819373,
                '../adapters/http': 1658887819383,
                './env/FormData': 1658887819385
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                './../utils': 1658887819361,
                './../core/settle': 1658887819374,
                './../helpers/cookies': 1658887819375,
                './../helpers/buildURL': 1658887819364,
                '../core/buildFullPath': 1658887819376,
                './../helpers/parseHeaders': 1658887819379,
                './../helpers/isURLSameOrigin': 1658887819380,
                '../defaults/transitional': 1658887819371,
                '../core/AxiosError': 1658887819370,
                '../cancel/CanceledError': 1658887819381,
                '../helpers/parseProtocol': 1658887819382
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                '../helpers/isAbsoluteURL': 1658887819377,
                '../helpers/combineURLs': 1658887819378
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
    ...
    __DEFINE__(
        ...
        function (require, module, exports) {
            ...
            var httpFollow = require('@/miniprogram_npm/follow-redirects').http;

            var httpsFollow = require('@/miniprogram_npm/follow-redirects').https;
    ...
    __DEFINE__(
        ...
        function (require, module, exports) {
            ...
            module.exports = require('@/miniprogram_npm/form-data');
        },
        function (modId) {
            var map = {};
            return __REQUIRE__(map[modId], modId);
