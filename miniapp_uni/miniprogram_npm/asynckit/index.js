module.exports = (function () {
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                './parallel.js': 1658887819319,
                './serial.js': 1658887819326,
                './serialOrdered.js': 1658887819327
            };
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                './lib/iterate.js': 1658887819320,
                './lib/state.js': 1658887819324,
                './lib/terminator.js': 1658887819325
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                './async.js': 1658887819321,
                './abort.js': 1658887819323
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
