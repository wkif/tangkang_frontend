module.exports = (function () {
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                './utils': 1658887819330,
                './helpers/bind': 1658887819331,
                './core/Axios': 1658887819332,
                './core/mergeConfig': 1658887819352,
                './defaults': 1658887819338,
                './cancel/Cancel': 1658887819353,
                './cancel/CancelToken': 1658887819354,
                './cancel/isCancel': 1658887819337,
                './helpers/spread': 1658887819355
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                './../utils': 1658887819330,
                '../helpers/buildURL': 1658887819333,
                './InterceptorManager': 1658887819334,
                './dispatchRequest': 1658887819335,
                './mergeConfig': 1658887819352
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                './utils': 1658887819330,
                './helpers/normalizeHeaderName': 1658887819339,
                './adapters/xhr': 1658887819340,
                './adapters/http': 1658887819350
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                './../utils': 1658887819330,
                './../core/settle': 1658887819341,
                './../helpers/buildURL': 1658887819333,
                '../core/buildFullPath': 1658887819344,
                './../helpers/parseHeaders': 1658887819347,
                './../helpers/isURLSameOrigin': 1658887819348,
                '../core/createError': 1658887819342,
                './../helpers/cookies': 1658887819349
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                '../helpers/isAbsoluteURL': 1658887819345,
                '../helpers/combineURLs': 1658887819346
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
    ...
    __DEFINE__(
        ...
        function (modId) {
            var map = {
                ...
                './../helpers/buildURL': 1658887819333,
                http: 1658887819350,
                './../../package.json': 1658887819351,
                '../core/createError': 1658887819342,
                '../core/enhanceError': 1658887819343
            };
            return __REQUIRE__(map[modId], modId);
        }
    );
