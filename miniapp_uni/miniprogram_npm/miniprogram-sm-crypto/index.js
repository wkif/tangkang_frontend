    ...
    (function (modules) {
        ...
        [
            ...
            function (module, exports) {
                module.exports = require('@/miniprogram_npm/jsbn');
                /***/
            },
            /* 1 */
            ...
            function (module, exports, __webpack_require__) {
                ...
                function sm3(array) {
                    ...
                    var n = m.length / 64;
                    var V = [
                        0x73, 0x80, 0x16, 0x6f, 0x49, 0x14, 0xb2, 0xb9, 0x17, 0x24, 0x42, 0xd7, 0xda, 0x8a, 0x06, 0x00, 0xa9, 0x6f, 0x30, 0xbc, 0x16, 0x31, 0x38, 0xaa, 0xe3, 0x8d,
                        0xee, 0x4d, 0xb0, 0xfb, 0x0e, 0x4e
                    ];
            ...
            function (module, exports, __webpack_require__) {
                ...
                function getHash(hashHex, publicKey) {
                    var userId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '1234567812345678'; // z = hash(entl || userId || a || b || gx || gy || px || py)
            ...
            function (module, exports, __webpack_require__) {
                ...
                function sms4Crypt(input, output, roundKey) {
                    var x = new Array(4); // 字节数组转成字数组（此处 1 字 = 32 比特）
